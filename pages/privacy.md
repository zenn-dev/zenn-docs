本サービスは、クラスメソッド株式会社（以下「当社」といいます）が運営するサービスです。本サービスにおける個人情報の取扱いは、「クラスメソッド株式会社・個人情報保護方針」を基本方針とし、本サービス固有の事項について本サービスプライバシーポリシー（以下「本ポリシー」といいます）で定めます。本ポリシーに定めのない事項については、「クラスメソッド株式会社・個人情報保護方針」が適用されます。当社は、以下のプライバシーポリシーを定め、個人の情報に関する保護法（平成十五年法律第五十七号、以下「個人情報保護法」）を遵守すると共に、適切なプライバシー情報の保護に努めます。
