...
オーナーやメンテナーは、Publicationのメンバー管理ページから、ZennのユーザーをPublicationに招待できます。招待するには以下の２つの方法があります。

- **招待リンクを利用する**
  招待リンクを生成し、招待したいユーザーにリンクを共有することで、ユーザーはPublicationに参加できます。招待リンクで参加したユーザーのロールは「投稿者」となります。
- **ユーザーを指定して招待する**
  ロールを指定してユーザーを招待します。招待を受け取ったユーザーは、招待メールに記載されたリンクから、招待を承諾できます。
...
除外されたメンバーがPublicationに投稿した記事の紐付けは、そのまま残ります。オーナーやメンテナーは、Publicationの記事の管理ページから、記事の紐付けを解除することができます。
