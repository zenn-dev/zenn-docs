...
Publicationの削除はメールにて受け付けています。以下の注意事項を確認いただいた上、下記の内容をメールにてお送りください。運営が内容を確認し、通常は2~3営業日程度で対応します。
...
メールの宛先は、 zenn-support@classmethod.jp です。
メールはPublicationのオーナーがZennに登録しているメールアドレスから送信してください。
