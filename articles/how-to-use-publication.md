...
- 企業や学校法人などのPublicationとして申請する場合、その名前を使用することについて関係者からの許可を取ったうえで申請してください。大規模な組織である場合は、自ら責任を取れる範囲の名前を利用してください（例: 〇〇株式会社△△チーム、など）
...
記事を投稿しても、記事は著者のコンテンツであり、編集権は著者にしかありません。
